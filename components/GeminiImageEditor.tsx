    ...
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 ring-1 ring-gray-900/5">
      <div className="bg-p4c-navy p-6 border-b border-gray-800">
        ...
        <p className="text-gray-300 text-sm mt-2">
          Visualize potential upgrades. Upload a photo of a room and describe
          changes (e.g., "Add hardwood floors and modern lighting").
        </p>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        {!selectedImage ? (
          ...
          >
            ...
            <p className="font-medium text-p4c-navy text-lg">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {loading ? (
                      ...
                      <Sparkles className="w-4 h-4 text-p4c-gold" />
                    )}
                    Visualize
                  </button>
                </div>
              ...
              {loading ? (
                ...
                <div className="text-center text-gray-400 p-6">
                  ...
                  <p className="text-sm font-medium">
                    Your visual renovation will appear here
                  </p>
                </div>
              )}
            </div>
