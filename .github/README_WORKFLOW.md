...
/n## 🚀 Quick Setup
/n1. **Copy this file** to your repository at `.github/workflows/deploy.yml` 2. **Ensure GitHub Pages is enabled** in repository settings 3. **Push to main branch** to trigger first deployment
/n## 📋 Workflow Features
