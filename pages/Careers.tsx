...
import { Briefcase, Users, ShieldCheck, HeartHandshake, Star } from 'lucide-react';
...
const Careers: React.FC = () => {
  return (
    <div className="bg-p4c-beige min-h-screen">
      <Helmet>
        <title>
          Careers | Join Our Team | Properties 4 Creation
        </title>
        <meta
          name="description"
      ...
      <div className="relative h-[400px] w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in-up">
          ...
          <p className="text-xl text-gray-200 font-light max-w-2xl mx-auto">
            Build a rewarding career while making a difference in East Texas communities
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                At Properties 4 Creation, we believe in creating opportunities - for our residents,
                our communities, and our team members. We foster a culture of professionalism,
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    We're committed to revitalizing East Texas communities through quality housing
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    We invest in our team's growth and create a supportive work environment
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-bold text-p4c-navy">Professional Growth</h4>
                  </div>
                  <p className="text-gray-600 text-sm">
        ...
        <section className="mb-20">
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-p4c-gold hover:shadow-2xl transition-shadow">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <h3 className="text-xl font-bold text-p4c-navy mb-2">Property Manager</h3>
                  <p className="text-gray-600 mb-4">
                    Manage our portfolio of residential properties, ensuring tenant satisfaction and property maintenance.
                  </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-p4c-gold hover:shadow-2xl transition-shadow">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <h3 className="text-xl font-bold text-p4c-navy mb-2">Maintenance Technician</h3>
                  <p className="text-gray-600 mb-4">
                    Perform maintenance and repairs on our residential properties to ensure they meet our quality standards.
                  </p>
                  <div className="flex flex-wrap gap-3 mb-4">
                    <span className="bg-p4c-navy/10 text-p4c-navy px-3 py-1 rounded-full text-sm font-medium">
                      Full-time
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-p4c-gold hover:shadow-2xl transition-shadow">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <h3 className="text-xl font-bold text-p4c-navy mb-2">Acquisitions Specialist</h3>
                  <p className="text-gray-600 mb-4">
                    Identify and evaluate potential property acquisitions in East Texas markets.
                  </p>
                  <div className="flex flex-wrap gap-3 mb-4">
                    <span className="bg-p4c-navy/10 text-p4c-navy px-3 py-1 rounded-full text-sm font-medium">
                      Full-time
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center hover:shadow-2xl transition-shadow">
              <div className="bg-p4c-navy/5 w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8 text-p4c-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-p4c-navy mb-4">Competitive Pay</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center hover:shadow-2xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-p4c-navy mb-4">Health Benefits</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center hover:shadow-2xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-p4c-navy mb-4">Career Growth</h3>
              <p className="text-gray-600">
        ...
        <section className="bg-p4c-navy rounded-2xl text-white p-12 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              We're always looking for passionate, skilled individuals who want to make a difference
              in East Texas communities. Whether you're in property management, construction, or
              acquisitions, we have opportunities for you to grow your career.
            </p>
