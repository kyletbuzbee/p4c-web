            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-p4c-gold hover:shadow-2xl transition-shadow">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-600 mb-4">
                    Perform maintenance and repairs on our residential
                    properties to ensure they meet our quality standards.
                  </p>
                  <div className="flex flex-wrap gap-3 mb-4">
                    <span className="bg-p4c-navy/10 text-p4c-navy px-3 py-1 rounded-full text-sm font-medium">
                      Full-time
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-p4c-gold hover:shadow-2xl transition-shadow">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-600 mb-4">
                    Identify and evaluate potential property acquisitions in
                    East Texas markets.
                  </p>
                  <div className="flex flex-wrap gap-3 mb-4">
                    <span className="bg-p4c-navy/10 text-p4c-navy px-3 py-1 rounded-full text-sm font-medium">
        ...
        <section className="bg-p4c-navy rounded-2xl text-white p-12 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              We're always looking for passionate, skilled individuals who want
              to make a difference in East Texas communities. Whether you're in
