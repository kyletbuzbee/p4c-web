...
const VeteranServices: React.FC = () => (
  <div className="bg-p4c-beige min-h-screen">
    <Helmet>
      ...
      <meta
        name="description"
        content="Comprehensive housing and support services for veterans in East Texas. HUD-VASH, employment, and community integration."
      />
    </Helmet>
    ...
    <div className="relative h-[400px] w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in-up">
        ...
        <p className="text-xl text-gray-200 hero-text-enhanced">
          We don&apos;t just provide housing; we provide a home base for your
          next chapter.
        </p>
      </div>
    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      {/* Core Services Grid */}
      <div className="mb-20">
        <h2 className="text-3xl font-serif font-bold text-p4c-navy text-center mb-12">
          Our Veteran Commitments
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-p4c-gold"
            >
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-20 border border-gray-100">
        <div className="bg-p4c-navy p-8 text-white">
          ...
          <p className="text-gray-300 mt-2">
            We accept and understand the following vouchers.
          </p>
        </div>
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-bold text-p4c-navy mb-2 flex items-center gap-2">
              <span className="bg-p4c-gold w-2 h-8 rounded-full" /> HUD-VASH
            </h3>
            <p className="text-gray-600 mb-4">
              We work directly with VA case managers to expedite inspections and
              lease-ups for the HUD-VASH program, ensuring homeless veterans
              move off the streets immediately.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-p4c-navy mb-2 flex items-center gap-2">
              <span className="bg-p4c-gold w-2 h-8 rounded-full" /> Section 8
              (HCV)
            </h3>
            <p className="text-gray-600 mb-4">
              Standard Housing Choice Vouchers are welcomed with no
              discrimination. Our properties pass HQS inspections on the first
              attempt 98% of the time.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-p4c-navy mb-2 flex items-center gap-2">
              <span className="bg-p4c-gold w-2 h-8 rounded-full" /> Rapid
              Rehousing
            </h3>
            <p className="text-gray-600 mb-4">
              Short-term rental assistance programs are accepted. We offer
              flexible lease terms to align with program duration.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-p4c-navy mb-2 flex items-center gap-2">
              <span className="bg-p4c-gold w-2 h-8 rounded-full" /> Disability
              Accessibility
            </h3>
            <p className="text-gray-600 mb-4">
              We provide reasonable accommodations including ramps, grab bars,
              and visual alarms at no cost to disabled veteran tenants.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <h2 className="text-2xl font-serif font-bold text-p4c-navy mb-6">
            Local Veteran Resources Directory
          </h2>
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="flex flex-col sm:flex-row sm:items-center justify-between bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:border-p4c-gold transition-colors"
              >
                <div>
        ...
        <div className="bg-p4c-navy text-white p-8 rounded-2xl h-fit">
          ...
          <p className="text-gray-300 mb-6 text-sm">
            If you are a veteran in crisis or at risk of homelessness, please
            contact the Veterans Crisis Line immediately.
          </p>
          <a
            href="tel:988"
            className="block w-full bg-p4c-gold text-p4c-navy text-center py-3 rounded-lg font-bold hover:bg-white transition-colors mb-4"
          >
            Call 988 (Press 1)
          </a>
          <p className="text-center text-xs text-gray-400">
            Confidential • 24/7 • Free
          </p>
        </div>
      </div>
    </div>
