...
const SuccessStories: React.FC = () => (
  <div className="bg-p4c-beige min-h-screen">
    <Helmet>
      ...
      <meta
        name="description"
        content="Read real stories from families and veterans housed by Properties 4 Creation. See our impact in East Texas."
      />
    </Helmet>
    ...
    <div className="bg-p4c-navy text-white py-20 text-center px-4">
      ...
      <p className="text-xl text-gray-300 max-w-2xl mx-auto">
        Behind every key we hand over is a story of resilience, hope, and a
        fresh start.
      </p>
    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 pb-20">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 mb-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center border-b-4 border-p4c-gold ring-1 ring-gray-900/5">
        <div>
          ...
          <div className="text-gray-500 uppercase tracking-widest text-sm font-semibold">
            Families Housed
          </div>
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {testimonials.map((story) => (
          <div
            key={story.id}
            className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col h-full border border-gray-100 ring-1 ring-gray-900/5 group"
          >
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="flex justify-between text-xs text-gray-500 mt-1">
                <span className="bg-p4c-beige px-2 py-1 rounded text-p4c-navy font-semibold">
                  {story.type}
                </span>
