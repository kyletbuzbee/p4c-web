      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-100">
            ...
            <div className="prose prose-slate max-w-none text-gray-700">
                <p className="lead">
                    Properties 4 Creation is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone, and applying the relevant accessibility standards.
                </p>

                <h3 className="text-xl font-bold text-p4c-navy mt-6 mb-2">Measures to support accessibility</h3>
                <p>Properties 4 Creation takes the following measures to ensure accessibility of our website:</p>
                ...
                <p>
                    ...
                    The Properties 4 Creation website is partially conformant with WCAG 2.1 level AA. Partially conformant means that some parts of the content do not fully conform to the accessibility standard.
                </p>

                <h3 className="text-xl font-bold text-p4c-navy mt-6 mb-2">Feedback</h3>
                <p>
                    We welcome your feedback on the accessibility of the Properties 4 Creation website. Please let us know if you encounter accessibility barriers on our site:
                </p>
                <p className="mt-4">
